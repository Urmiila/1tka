        ...
        <div class="container py-5">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 pb-4">
                    <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="javastudentpage">
                        <img class="img-fluid" src="img/courses-1.jpg" alt="">
                        <div class="courses-text">
                            <h1 class="text-center text-white px-3">Core Java</h1>
                            <div class="border-top w-100 mt-3">
                                <div class="d-flex justify-content-between p-4">
                                    <span class="text-white"><i class="fa fa-user mr-2"></i>Sagar Dhawale</span>
                                    <span class="text-white"><i class="fa fa-star mr-2"></i>4.6
                                        <small>(265)</small></span>
                                </div>
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-lg-4 col-md-6 pb-4">
                    <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="advancejavastudentpage">
                        <img class="img-fluid" src="img/courses-2.jpg" alt="">
                        <div class="courses-text">
                            <h1 class="text-center text-white px-3">Advance Java</h1>
                            <div class="border-top w-100 mt-3">
                                <div class="d-flex justify-content-between p-4">
                                    <span class="text-white"><i class="fa fa-user mr-2"></i>GopalSing Girase</span>
                                    <span class="text-white"><i class="fa fa-star mr-2"></i>5.0
                ...
                <div class="col-lg-4 col-md-6 pb-4">
                    <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="seleniumstudentpage">
                        <img class="img-fluid" src="img/courses-3.jpg" alt="">
                        <div class="courses-text">
                            <h1 class="text-center text-white px-3">Selenium</h1>
                            <div class="border-top w-100 mt-3">
                                <div class="d-flex justify-content-between p-4">
                                    <span class="text-white"><i class="fa fa-user mr-2"></i>Pradip Kalunke</span>
                                    <span class="text-white"><i class="fa fa-star mr-2"></i>3.5
                                        <small>(252)</small></span>
                                </div>
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-lg-4 col-md-6 pb-4">
                    <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="pythonstudentpage">
                        <img class="img-fluid" src="img/courses-4.jpg" alt="">
                        <div class="courses-text">
                            <h1 class="text-center text-white px-3">Python</h1>
                            <div class="border-top w-100 mt-3">
                                <div class="d-flex justify-content-between p-4">
                                    <span class="text-white"><i class="fa fa-user mr-2"></i>Santosh Markad</span>
                                    <span class="text-white"><i class="fa fa-star mr-2"></i>3.2
                                        <small>(211)</small></span>
                                </div>
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-lg-4 col-md-6 pb-4">
                    <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="awsstudentpage">
                        <img class="img-fluid" src="img/courses-5.jpg" alt="">
                        <div class="courses-text">
                            <h1 class="text-center text-white px-3">AWS</h1>
                            <div class="border-top w-100 mt-3">
                                <div class="d-flex justify-content-between p-4">
                                    <span class="text-white"><i class="fa fa-user mr-2"></i>Altaf Shaikh</span>
                                    <span class="text-white"><i class="fa fa-star mr-2"></i>3.1
                                        <small>(206)</small></span>
                                </div>
                            </div>
                        </div>
                    </a>
                ...
                <div class="col-lg-4 col-md-6 pb-4">
                    <a class="courses-list-item position-relative d-block overflow-hidden mb-2" href="salesforcestudentpage">
                        <img class="img-fluid" src="img/courses-6.jpg" alt="">
                        <div class="courses-text">
                            <h1 class="text-center text-white px-3">Salesforce</h1>
                            <div class="border-top w-100 mt-3">
                                <div class="d-flex justify-content-between p-4">
                                    <span class="text-white"><i class="fa fa-user mr-2"></i>Atul Patil</span>
                                    <span class="text-white"><i class="fa fa-star mr-2"></i>3.6
                                        <small>(201)</small></span>
                                </div>
                            </div>
                        </div>
                    </a>
