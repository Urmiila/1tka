...
<body>
	...
	<center>
		<h1>SalesForce Student Courses Table Record</h1>
	...
	<table>
		...
		Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3307/Allsetedu", "root", "root");
		PreparedStatement ps = connection.prepareStatement("select * from sales_force_student");
