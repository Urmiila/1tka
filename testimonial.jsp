        ...
        <div class="container py-5">
            <div class="row align-items-center">
                <div class="col-lg-5 mb-5 mb-lg-0">
                    ...
                    <p class="m-0">The course allowed me to manage my time efficiently, identify necessary recourses, create and adjust timelines and also effectively communicate the process and status to stakeholders. 
The software development methodologies, discussed in detail in the Intro to Software Engineering course, were utilized in order to decide which methodology would be better for my first project.</p>
                </div>
                <div class="col-lg-7">
                    <div class="owl-carousel testimonial-carousel">
                        <div class="bg-light p-5">
                            <i class="fa fa-3x fa-quote-left text-primary mb-4"></i>
                            <p>Core java batch -500
Trainer name -  Santosh Sir
Santosh sir has made the Core java easy learning.Sir has very good Command on theory knowledge and also practicing well.
Advanced java batch - 140
Trainer name - Gopal sir
Gopal sir teaching is too good. And sir always help in any doubts and too Supportive.Sir is always focuses on practicing student to get the students command on advanced java easily.Sir make teaching  in easier way to understand.
The Kiran Academy Providing such industrial training at Affordable cost with Quality teaching.
The all the team of The Kiran Academy from counsellor to Admin team they are too Supportive and always ready to help.
</p>
                        ...
                        <div class="bg-light p-5">
                            <i class="fa fa-3x fa-quote-left text-primary mb-4"></i>
                            <p>The Kiran academy is a good institute. 
I just wanted let you know that the service provided, from registration to training is a very positive experience for me, & I referring any new hires as well as friends/family members to take courses at jbk.

Wonderful  Training by Gopal sir :
I thank you for being such a amazing teacher and all for your great lessons. l feel so fortunate to have been placed your class, excellent communication skills and great vocabulary.
The way the trainer began session and steered it towards the topic of discussion is very candid and it is amazing skill.
Each & every day I was waiting to learn many things from u and I learner. U sorted my each & every queries...

Thank  you...

Batch no : - 140
Core java trainer :- Agrawal sir
Advance Java trainer :- Gopal sir</p>
                            <div class="d-flex flex-shrink-0 align-items-center mt-4">
