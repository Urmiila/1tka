            ...
            <div class="owl-carousel team-carousel position-relative" style="padding: 0 30px;">
                <div class="team-item">
                    ...
                    <div class="bg-light text-center p-4">
                        <h5 class="mb-3">Mr. Kiran Digrase</h5>
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <a class="mx-1 p-1" href="https://www.youtube.com/@TheKiranAcademy"><i class="fab fa-youtube"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="team-item">
                    <img class="img-fluid w-100" src="img/team-2.bmp" alt="">
                    <div class="bg-light text-center p-4">
                        <h5 class="mb-3">Mr. GopalSing Girase</h5>
                        <p class="mb-2">Instructor</p>
                        <div class="d-flex justify-content-center">
                            <a class="mx-1 p-1" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                            <a class="mx-1 p-1" href="https://www.facebook.com/"><i class="fab fa-facebook-f"></i></a>
                            <a class="mx-1 p-1" href="https://www.linkedin.com/"><i class="fab fa-linkedin-in"></i></a>
                            <a class="mx-1 p-1" href="https://www.instagram.com/"><i class="fab fa-instagram"></i></a>
                            <a class="mx-1 p-1" href="https://www.youtube.com/@JavaWithGG"><i class="fab fa-youtube"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="team-item">
                    ...
                    <div class="bg-light text-center p-4">
                        <h5 class="mb-3">Mr. Sagar Dhawale</h5>
                        <p class="mb-2">Instructor</p>
                        <div class="d-flex justify-content-center">  <a class="mx-1 p-1" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                            <a class="mx-1 p-1" href="https://www.facebook.com/"><i class="fab fa-facebook-f"></i></a>
                            <a class="mx-1 p-1" href="https://www.linkedin.com/"><i class="fab fa-linkedin-in"></i></a>
                            <a class="mx-1 p-1" href="https://www.instagram.com/"><i class="fab fa-instagram"></i></a>
                            <a class="mx-1 p-1" href="https://www.youtube.com/@easy_javabysagar1736"><i class="fab fa-youtube"></i></a>
                        </div>
                    </div>
                </div>
                <div class="team-item">
                    ...
                    <div class="bg-light text-center p-4">
                        <h5 class="mb-3">Mr. Amit Agrawal</h5>
                        <p class="mb-2">Instructor</p>
                        <div class="d-flex justify-content-center">
                      <div class="d-flex justify-content-center">  <a class="mx-1 p-1" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                            <a class="mx-1 p-1" href="https://www.facebook.com/"><i class="fab fa-facebook-f"></i></a>
